#!/bin/bash
# // PROJECT STORE
url_izin="https://raw.githubusercontent.com/king-vpn/permission/main/ip"
...
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[0;36mWhatsapp${NC} wa.me/+6281775700114"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
...
git clone https://github.com/king-vpn/permission.git /root/ipvps/ &> /dev/null
clear
echo -e ""
